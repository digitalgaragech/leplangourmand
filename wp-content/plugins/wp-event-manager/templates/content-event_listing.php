...
?>
<div class="wpem-event-date"><?php display_event_start_date(); ?></div>
        ...
        <div <?php event_listing_class(''); ?>>
                ...
                <div class="wpem-event-infomation">
                    ...
                    <div class="wpem-event-details">
                        ...
                        <div class="wpem-event-title"><h3 class="wpem-heading-text"><a href="<?php display_event_permalink(); ?>" class="wpem-event-action-url event-style-color <?php echo esc_attr($event_type); ?>"><?php echo esc_html(get_the_title()); ?></a></h3></div>

                        <div class="wpem-event-date-time">
                            <span class="wpem-event-date-time-text">
                                de <?php display_event_start_time(); ?> à <?php display_event_end_time(); ?>
                            </span>
                        </div>
